...
Future<void> main() async {
  ...
  Result? downloadHandler(Invocation inv) {
    ...
    if (isProgress) {
      ...
      inv.sendProgress([chunkIndex], null);
      return null;
    }
  ...
  var registration = await callee.register(procedureProgress, downloadHandler);
  print("Registered procedure $procedureProgress successfully");
